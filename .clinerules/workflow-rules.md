...
## Integration with Plan Directing System
When workflows involve complex multi-phase tasks, consider integrating with the plan-directing-rule.md system:
- Reference plan-directing-rule.md for task pickup and dependency management
- Use plan-creation-standards.md for standardized plan structure
- Include agent commands for each phase (e.g., `cline task "pick up Phase 1 from plan-name"`)
- Document file dependencies to prevent conflicts between phases
- Use standardized progress tracking format for real-time status updates
